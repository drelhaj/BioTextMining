package com.isugang.bioparser.simpleobo;
...
public class SimpleOBOTree {
    ...
    public HashMultimap<String, String> goTree = HashMultimap.create();
    public HashMap<String, SimpleOBOEntry> goTermHash = new HashMap<>();
    public HashMultimap<String, String> parentsTree = HashMultimap.create();
    ...
    public void addParentBranch(String child , String parent) {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (line.length() == 0) {
                ...
                if (line.startsWith("id:")) {
                    ...
                    simpleOboTree.addParentBranch(currentChildTerm, line);
    ...
    public Set<String> getParentNodes(String childNodeID){
        return parentsTree.get(childNodeID);
    }
