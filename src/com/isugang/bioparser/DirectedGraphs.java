...
public class DirectedGraphs<V> {
    ...
    public static void main (String[] args) {
        ...
        DirectedGraphs<Integer> graph = new DirectedGraphs<Integer>();
        //nodes= [0.1, 0.2, 0.3, 2.4, 1.4, 1.5, 3.5, 4.6, 5.6, 6.7, 12.7, 7.8, 14.9, 7.9, 9.10, 8.10, 10.11, 5.12, 15.13, 12.13, 13.14, 3.15]
//        all Levels: [0.1, 0.2, 1.3, 1.4, 2.5, 3.5, 5.6, 6.7, 6.8, 8.9, 7.9, 12.9, 4.10, 10.11, 11.12]

        		
        graph.add(0, 1); graph.add(0, 2); graph.add(1, 3);
        graph.add(1, 4); graph.add(2, 5); graph.add(3, 5);
        graph.add(5, 6); graph.add(6, 7); graph.add(6, 8);    // Tetrahedron with tail
        graph.add(8, 9); graph.add(7, 9); graph.add(12, 9);
        graph.add(4, 10); graph.add(10, 11); graph.add(11, 12);
