...
public class XMLParsers {
	...
	public static void main(String argv[]) throws NullPointerException {
		...
		try {
			...
			writer = new PrintWriter("C:\\Users\\elhaj\\Desktop\\pubMed\\output.csv");
			writer.println("PMID" + "," + "Status" + "," + "Owner" + "," + "Year" + "," + "Month" + "," + "Day"
				   + "," + "ISSN"+ "," + "Volume"+ "," + "ArticleTitle"+ "," + "Abstrtact"+ "," + "AuthorsAndAffiliations" + "," + "PubMedID"+ "," + "DOI"+ "," + "PII");
			writer.flush();
			File fXmlFile = new File("C:\\Users\\elhaj\\Desktop\\pubMed\\genePsychExtractor.xml");
